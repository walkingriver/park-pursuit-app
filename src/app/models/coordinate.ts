...
export class Coordinate {
  ...
  static empty(): Coordinate {
    return new Coordinate(
      DMS.empty(LocationType.Latitude),
      DMS.empty(LocationType.Longitude)
    );
  }
  ...
  bearingTo(point: Coordinate) {
    ...
    var φ1 = this.latitude.toRadians(),
      φ2 = point.latitude.toRadians();
    var Δλ = this.toRadians(
      point.longitude.asDecimal() - this.longitude.asDecimal()
    );
